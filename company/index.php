...
if(isset($_POST['signup'])){
  ...
  $name=$_POST['username']; 
             ...
             $mail=$_POST['mail'];
           $sql="INSERT INTO  company(name,password,mail) VALUES(:name,:password,:mail)";
...
$password=$_POST['password'];
$sql ="SELECT name,password FROM company WHERE name=:uname and password=:password";
$query= $dbh -> prepare($sql);
                    ...
                    <div class="login-space">
                        <div class="login">
                          <form method="POST">
                            ...
                            <div class="group"> <input type="submit" class="button" value="Sign In" name="signin"> </div>
                            <div class="hr"></div>
                        ...
                        <div class="sign-up-form">
                          <form method="POST">
                            <div class="group"> <label for="user" class="label">Username</label> <input id="user" name="username" type="text" class="input" required> </div>
                            <div class="group"> <label for="pass" class="label">Password</label> <input id="pass" name="password" type="password" class="input" data-type="password" required> </div>
                            ...
                            <div class="group"> <label for="pass" class="label">Email Address</label> <input id="pass" name="mail" type="text" class="input" required> </div>
