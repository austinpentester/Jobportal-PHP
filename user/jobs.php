    ...
    header("Location: index.php"); 
      ...
      if(isset($_POST['submit']))
      {
        ...
        $yourname=$_SESSION['alogin'];
              ...
              //echo $mark;
              $co= count($id);
              $sqlu="update  adduser set mark=:mark where yourname=:yourname ";
  ...
  <header class="stick-top style3">
    <div class="menu-sec">
      <div class="container">
        ...
        <div class="btn-extars">
          <a href="question.php" title="" class="post-job-btn" target="_blank"> Question</a>
          <a href="jobs.php" title="" class="post-job-btn" target="_blank"> Jobs</a>
          <!-- <ul class="account-btns">
            <li class="signup-popup"><a title=""><i class="fa fa-key"></i> Sign Up</a></li>
            <li class="signin-popup"><a title=""><i class="fa fa-external-link-square"></i> Login</a></li>
          </ul> -->
  ...
  <section>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h4 class="m-0 text-dark">Jobs</h4>
          </div><!-- /.col -->
          ...
          <div class="panel-body">
            <?php
              ...
              if($query->rowCount() > 0){
                ...
                ?>
                <div class="jobdiv">
                  <h4>Job Title : <?php echo $result->jobtitle;?></h4>
                  <p>Job Description : <?php echo $result->jobdescription;?></p>
                  <p>Posted By : <?php echo $result->companyname;?></p>
                </div>
                <?php
              }}?>
          </div>
