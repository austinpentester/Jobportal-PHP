...
if(isset($_GET['delete'])){
    ...
    $sqli = "DELETE FROM `examinee_tbl` WHERE exmne_id='$id'";
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    if($query->rowCount() > 0){
                      ...
                      ?>
                      <tr>
                        <td><?php echo $result->exmne_id;?></td>
                        <td><?php echo $result->exmne_fullname;?></td>

                        <td><?php echo $result->exmne_email;?></td>
                  
               
                        <td><a href="?delete=<?php echo $result->exmne_id;?>" class="btn btn-danger">Delete</a></td>
                      </tr>
                      <?php 
                      }   
                    }
